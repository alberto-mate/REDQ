...
# REDQ with alpha = 0.05 and N=5, G=5, M=2
echo "Running REDQ with alpha = 0.05 and N=5, G=5, M=2"
python main.py --env BipedalWalker-v3 --kwargs N=5 G=5 M=2 alpha=0.05 --exp_name REDQ_alpha0.05_N5_G5_M2 --total_timesteps 400000 --seed 1
python main.py --env BipedalWalker-v3 --kwargs N=5 G=5 M=2 alpha=0.05 --exp_name REDQ_alpha0.05_N5_G5_M2 --total_timesteps 400000 --seed 2
